...
function init_addon()
{
  ...
  document.getElementById("de").addEventListener("keydown", function(event) {
    if (event.keyCode === 13) {
  ...
  document.getElementById("en").addEventListener("keydown", function(event) {
    if (event.keyCode === 13) {
      event.preventDefault();
      translate_click();
    }
  ...
  document.getElementById("es").addEventListener("keydown", function(event) {
    if (event.keyCode === 13) {
      event.preventDefault();
      translate_click();
    }
